...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{training/multitask+normals_with_lidar_and_rgb-validation-surface_normal_loss.pdf}
...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{training/multitask+segmentation_with_lidar_and_rgb-validation-surface_segmentation_loss.pdf}
