...
\input{chapters/data/coordinate-systems}
...
\input{chapters/data/vector-data}

\subsection{Raster data}%
\label{sec:raster-data}
\input{chapters/data/raster-data}
...
\input{chapters/data/processing-overview.tex}
