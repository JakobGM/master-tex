...
\begin{figure}
  ...
  \hspace{3em}
  \subfloat[Illustration of the \enquote{bird's eye view decision rule}.]{\includegraphics[width=0.3\linewidth]{ray-tracing.tikz}}
  \\
  \subfloat[Overlapping three-dimensional polygons.]{\includegraphics[width=0.4\linewidth]{dormer-3D.tikz}}
  \hspace{3em}
  \subfloat[Instance mask resulting from decision rule.]{\includegraphics[width=0.4\linewidth]{dormer-2D.tikz}}
  \caption{%
