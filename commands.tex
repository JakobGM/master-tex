...
\newcommand{\instraster}[0]{L}
\newcommand{\predinstraster}[0]{\widehat{L}}

% Loss functions
\newcommand{\mtloss}[0]{\mathcal{L}_{\mathrm{MT}}}
\newcommand{\mtlossf}[0]{\mtloss\left(\predsegraster, \prednormraster; \segraster, \normraster\right)}
\newcommand{\segloss}[0]{\mathcal{L}_{\mathrm{SJL}}}
\newcommand{\seglossf}[0]{\segloss\left(\predsegraster; \segraster\right)}
\newcommand{\normloss}[0]{\mathcal{L}_{\mathrm{norm}}}
\newcommand{\normlossf}[0]{\normloss\left( \prednormraster; \normraster \right)}
...
% Defines the \segnormalresult command
\input{tikz/segmented-normal-result.tex}
% Defines the \polygonresult command
\input{tikz/polygon-result.tex}
